...
const Index = () => {
  ...
  return <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <Button onClick={openWhatsApp} className="fixed left-4 top-1/2 transform -translate-y-1/2 z-50 bg-green-500 hover:bg-green-600 text-white w-14 h-14 rounded-full p-0 shadow-2xl" size="icon">
      ...
      <section className="relative h-[70vh] overflow-hidden">
        ...
        <div className="absolute left-4 bottom-0 translate-y-1/2 z-[200]">
          {/* White circle background - behind the button */}
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-0 w-32 h-16 bg-white rounded-b-full shadow-lg z-[-1]" />
