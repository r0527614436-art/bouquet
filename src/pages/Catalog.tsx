              ...
              <form onSubmit={handleContactSubmit} className="space-y-4 p-8">
                ...
                <div className="flex items-start gap-3 mt-4">
                  <div className="relative flex-shrink-0">
                    ...
                    />
                    <label
                      htmlFor="privacy-checkbox-catalog"
                    ...
                    >
                      <svg
                        className="h-7 w-7 text-[#314020] transition-transform duration-200 -mt-1 -mr-1"
                  ...
                  <label htmlFor="privacy-checkbox-catalog" className="text-sm text-gray-600 font-ploni-aaa cursor-pointer text-right">
