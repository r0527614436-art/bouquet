    ...
    <>
      ...
      >
        <a
          ...
          className="flex items-center justify-center w-20 h-20 bg-[#25D366] rounded-full hover:bg-[#20BA5A] transition-all duration-300 shadow-2xl hover:scale-110"
          style={{
