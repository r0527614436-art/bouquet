...
const SideNavigation = () => {
  ...
  return (
    <>
      {/* Desktop Navigation */}
      <div 
        className={`hidden md:block fixed right-0 top-0 h-screen bg-primary transition-all duration-300 ease-in-out z-50 ${
      ...
      >
        <a
          href="https://wa.me/972527614436"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-center w-16 h-16 md:w-20 md:h-20 bg-[#25D366] rounded-full hover:bg-[#20BA5A] transition-all duration-300 shadow-2xl hover:scale-110"
          style={{
        ...
        >
          <svg
            viewBox="0 0 24 24"
            className="w-9 h-9 md:w-11 md:h-11 fill-white"
