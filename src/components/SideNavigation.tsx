  ...
  return (
    ...
    >
      <div className="flex flex-col h-full py-8 bg-[#11150d]">
        ...
        <div className="fixed bottom-8 right-16 z-[60]">
          <a
            href="https://wa.me/972527614436"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center w-16 h-16 bg-[#25D366] rounded-full hover:bg-[#20BA5A] transition-all duration-300 shadow-2xl hover:scale-110"
            style={{
